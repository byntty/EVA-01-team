    ...
    routes: [
      {
        ...
        terrain: 'Тропа → Гребень',
        description:
          'Старт с Бутаковского ущелья, можно доехать на машине/такси либо пешком с остановки Музтау.',
      highlights: [
     ...
     equipment: [
      {
        ...
        items: [
          { name: 'Термобелье', essential: true },
          { name: 'Трекинговые штаны', essential: true },
          { name: 'Трекинговые палочки', essential: true },
          { name: 'Ветрозащитаня куртка ', essential: true },
        ],
      },
      {
        category: 'Снаряжение',
      ...
      },
      {
      ...
      
       {
        ...
        items: [
          { name: 'Аптечка', essential: true },
          { name: 'Солнцезащитный крем SPF 50+', essential: true },
          { name: 'Спрей от насекомых', essential: false },
        ],
      },
    ],
    safety: {
      rules: [
        ...
        'Ориентируйтесь по GPS или ориентирам на маршруте',
            'Разворот не позже 14:00 в любом случае',
        'Заранее проверяйте прогноз погоды',
                  'Не ходить в одиночку, особенно в плохую погоду',
 'Убирать мусор за собой',
      ],
      emergencyContacts: [
        { label: 'МЧС Казахстана', number: '112' },
        { label: 'Служба спасения Алматы', number: '+7-727-250-39-39' },
      ...
      tips: [
       'Оптимально начинать маршрут до 7:30 утра',
        'В случае поездке на такси, заранее согласуйте время и место встречи с водителем на обратный путь',
